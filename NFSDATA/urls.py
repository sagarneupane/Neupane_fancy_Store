...
urlpatterns = [
    ...
    path("create_bill/",SearchForGenerateView.as_view(),name="create_bill"),
    path("pop_one/",PopItemsView.as_view(),name="pop_one"),
    path("pop_selected_item/<id>",PopSelectedItem.as_view(),name="pop_selected"),
